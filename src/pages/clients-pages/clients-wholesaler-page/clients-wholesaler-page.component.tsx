...
import '../clients-wholesaler-page/clients-wholesaler-page.style.css';
...
import ClientsWholesalerTable from '../../../components/clients-wholesaler-table/clients-wholesaler-table.component';
import VisitModel from '../../../models/visit.model';
import VisitService from '../../../services/visit.service';
import ReportService from '../../../services/report.service';
import ReportPanel from '../../../components/report-panel/report-panel.component';

interface ClientsWholesalerPageProps {
    selectedDate: Date;
    hasData: boolean;
    isLoading: boolean;
    searchText: string;
...
class ClientsWholesalerPage extends Component<{}, ClientsWholesalerPageProps> {
    constructor({ }) {
        super({});
        this.state = {
    ...
    loadClientsWholesalerPageData = async () => {
    ...
    render() {
        ...
        if (!this.state.hasData) {
            this.loadClientsWholesalerPageData();
            return (
                <div style={{
                    width: '100%',
                    height: '100vh',
            ...
            return (
                <div className='clients-wholesaler-container' style={{display:'flex',flexDirection:'column',height:'100%',alignItems:'stretch',backgroundColor:'#eee'}}>
                    ...
                    <div style={{width:'100%',display:'flex',flexGrow:'1'}}>
                        <ClientsWholesalerTable id='clients-wholesaler-table' data={this.state.filteredVisits} isLoading={this.state.loadingVisitsData} displayCommand={this.handleDisplayCommand} displayReport={this.handleDisplayReport}></ClientsWholesalerTable>
...
export default ClientsWholesalerPage;
